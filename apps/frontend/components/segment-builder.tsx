...
export function SegmentBuilder({ onSave }: SegmentBuilderProps) {
  const [segmentName, setSegmentName] = useState("Casual Jacket Lovers")
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <div className="flex items-center mt-2">
          <div className="flex items-center gap-2">
            ...
            <Button variant="link" onClick={() => setEditingName(true)} className="text-blue-500 h-auto p-0">
              Change
            </Button>
          </div>
        </div>
      ...
      <div>
        ...
        <Button variant="outline" onClick={addCondition} className="mt-4 flex items-center gap-2 text-blue-500">
          <PlusCircle className="h-4 w-4" />
          Add condition
        </Button>
      </div>

      <Button className="bg-blue-600 hover:bg-blue-700 text-white mt-6 px-8" onClick={handleSave}>
        Save Segment
      </Button>
    </div>
  )
